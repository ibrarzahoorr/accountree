  ...
  return (
    <section className="relative w-full bg-black">
      ...
      <div className="relative hidden h-[916px] w-full lg:block">
        ...
        {/* Video thumbnail */}
        <div className="absolute left-[247px] top-[460px] h-[456px] w-[1098px] overflow-hidden rounded-lg">
          <Image
            src="/images/home/hero-video-thumb.png"
            alt="Learn the accountree model"
            fill
          ...
          <div className="absolute left-[482px] top-[407px] flex h-[25px] w-[135px] items-center gap-2">
